      ...
      <div class="row gy-4">
          ...
          <div id="carouselExampleAutoplaying" class="carousel slide my-3" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="assets/img/services/CodeCrane-65a9bd9c2c1a61.4316681920240107_171509_0000-982x500.png" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets/img/services/landingPage.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets/img/services/PSD to html.png" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <div class="col-lg-5">
          <div class="servies-details-payment">
            <h4 class="dollar">10$</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus quibusdam odit incidunt? Eligendi
              distinctio nihil soluta veritatis expedita aspernatur numquam.</p>
            <div class="rev-icons">
              <p><i class="fa fa-clock"></i> 2 days Delevery </p>
              <p><i class="fa fa-refresh"></i> 2 days Delevery </p>
            </div>
            <ul class="ser-include">
              What's Include? <br>
              <li><i class="fa fa-check"></i> 2 Page Website</li>
              <li><i class="fa fa-check"></i> 2 Page Website</li>
              <li><i class="fa fa-check"></i> 2 Page Website</li>
              <li><i class="fa fa-check"></i> 2 Page Website</li>
            </ul>
            ...
            <a href="#" style="
                    ...
                    justify-content: space-around; ">Contact </a> <br>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="cards-wrapper">
            <a href="#">
              <div class="card">
                <img src="assets/img/services/CodeCrane-65a9bd9c2c1a61.4316681920240107_171509_0000-982x500.png" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card d-none d-md-block">
              <img src="assets/img/services/landingPage.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                  card's content.</p>
